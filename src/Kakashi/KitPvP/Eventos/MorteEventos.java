...
public class MorteEventos implements Listener
{
    ...
    public void aoMorrer(final PlayerDeathEvent e) {
        ...
        if (e.getEntity().getKiller() instanceof Player) {
            ...
            matou.sendMessage(String.valueOf(API.preffix) + "§7Voc\u00ea matou: §4" + morreu.getDisplayName() + " §7+5 de XP");
            morreu.sendMessage(String.valueOf(API.preffix) + "§7Voc\u00ea morreu para: §4" + matou.getDisplayName() + " §7-1 de XP");
