...
public class Xp implements CommandExecutor
{
    ...
    static {
        ...
        Xp.semquantia = String.valueOf(API.preffix) + "§cVoc\u00ea nao tem a quantia suficiente de xp que quer doar §4✗";
                    ...
                    if (sender.hasPermission("flame.darxp")) {
                        try {
                            ...
                            if (t != null) {
                                ...
                                sender.sendMessage(String.valueOf(API.preffix) + "§7Voc\u00ea deu §4" + xp + "§7 Xp para o(a) §4" + t.getDisplayName());
                                t.sendMessage(String.valueOf(API.preffix) + "§7Um(Uma) staffer te deu §4" + xp + " §7Xp");
                            }
                            else {
                    ...
                    try {
                        ...
                        if (t != null) {
                            ...
                            if (KillsDeathsRankXp.getXp(p) >= xp) {
                                ...
                                t.sendMessage(String.valueOf(API.preffix) + "§7O(A) §e" + sender.getName() + " §7te deu §4" + xp + " §7Xp");
                                sender.sendMessage(String.valueOf(API.preffix) + "§7Voc\u00ea deu §4" + xp + " §7Xp para o(a) §e" + t.getDisplayName());
                            }
                            else {
