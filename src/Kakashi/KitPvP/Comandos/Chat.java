            ...
            if (args.length > 0) {
                if (args.length == 1) {
                    if (args[0].equalsIgnoreCase("off")) {
                        Chat.chat1 = false;
                        Bukkit.broadcastMessage(String.valueOf(API.preffix) + "§7Chat desativado por §5" + sender.getName());
                    }
                    else if (args[0].equalsIgnoreCase("on")) {
                        Chat.chat1 = true;
                        Bukkit.broadcastMessage(String.valueOf(API.preffix) + "§7Chat ativado por §5" + sender.getName());
                    }
                }
                else {
