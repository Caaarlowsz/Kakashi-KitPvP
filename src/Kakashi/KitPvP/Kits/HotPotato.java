        ...
        if (e.getRightClicked() instanceof Player) {
            ...
            if (p.getItemInHand().getType().equals((Object)Material.getMaterial(392)) && Habilidade.getAbility(p).equalsIgnoreCase("HotPotato")) {
                if (Gladiator.lutando.containsKey(p.getName())) {
                    p.sendMessage(String.valueOf(API.preffix) + "§cVoc\u00ea n\u00e3o poder usar seu kit no gladiator ent\u00e3o vai §aganhar §eum efeito de §afor\u00e7a §ee §aspeed");
                    ...
                    k.sendMessage(String.valueOf(API.preffix) + "§eVoc\u00ea est\u00e1 com a tnt do hotpotato tire ou ira explodir em 5 segundos");
                    k.sendMessage(String.valueOf(API.preffix) + "§cClick com o botao direito na hotpotato para tira-la");
                    ...
                    new BukkitRunnable() {
                        public void run() {
                            if (HotPotato.emhotpotato.contains(k.getName())) {
                                k.sendMessage(String.valueOf(API.preffix) + "§eVoc\u00ea est\u00e1 com a tnt, explodindo em 4 segundos");
                                k.sendMessage(String.valueOf(API.preffix) + "§cClick com o botao direito na hotpotato para tira-la");
                            }
                        }
                    ...
                    new BukkitRunnable() {
                        public void run() {
                            if (HotPotato.emhotpotato.contains(k.getName())) {
                                k.sendMessage(String.valueOf(API.preffix) + "§eVoc\u00ea est\u00e1 com a tnt, explodindo em 3 segundos");
                                k.sendMessage(String.valueOf(API.preffix) + "§cClick com o botao direito na hotpotato para tira-la");
                            }
                        }
                    ...
                    new BukkitRunnable() {
                        public void run() {
                            if (HotPotato.emhotpotato.contains(k.getName())) {
                                k.sendMessage(String.valueOf(API.preffix) + "§eVoc\u00ea est\u00e1 com a tnt, explodindo em 2 segundos");
                                k.sendMessage(String.valueOf(API.preffix) + "§cClick com o botao direito na hotpotato para tira-la");
                            }
                        }
                    ...
                    new BukkitRunnable() {
                        public void run() {
                            if (HotPotato.emhotpotato.contains(k.getName())) {
                                k.sendMessage(String.valueOf(API.preffix) + "§c§lVoc\u00ea est\u00e1 com a tnt, explodindo em 1 segundo");
                                k.sendMessage(String.valueOf(API.preffix) + "§cClick com o botao direito na hotpotato para tira-la");
                            }
                        }
